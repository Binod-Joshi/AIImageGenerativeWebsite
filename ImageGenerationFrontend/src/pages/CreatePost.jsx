  ...
  const generateImage =async() => {
    if(form.prompt){
      try {
        ...
        const response = await fetch(`${import.meta.env.VITE_APP_BASE_URL_BACKEND}/api/v1/dalle`,{
          method:'POST',
          headers: {
      ...
      <form className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
        <div className="flex flex-col gap-5">
          ...
          <FormField
            ...
            type="text"
            name="prompt"
            placeholder="A boy is looking at the luxurious car."
            value={form.prompt}
            handleChange={handleChange}
            isSurpriseMe
